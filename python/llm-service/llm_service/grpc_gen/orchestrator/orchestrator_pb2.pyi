...
class SubmitReviewDecisionRequest(_message.Message):
    __slots__ = ("workflow_id", "approved", "final_plan", "conversation", "approved_by", "research_brief")
    WORKFLOW_ID_FIELD_NUMBER: _ClassVar[int]
    APPROVED_FIELD_NUMBER: _ClassVar[int]
    FINAL_PLAN_FIELD_NUMBER: _ClassVar[int]
    CONVERSATION_FIELD_NUMBER: _ClassVar[int]
    APPROVED_BY_FIELD_NUMBER: _ClassVar[int]
    RESEARCH_BRIEF_FIELD_NUMBER: _ClassVar[int]
    workflow_id: str
    approved: bool
    final_plan: str
    conversation: str
    approved_by: str
    research_brief: str
    def __init__(self, workflow_id: _Optional[str] = ..., approved: bool = ..., final_plan: _Optional[str] = ..., conversation: _Optional[str] = ..., approved_by: _Optional[str] = ..., research_brief: _Optional[str] = ...) -> None: ...

class SubmitReviewDecisionResponse(_message.Message):
    __slots__ = ("success", "message")
    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    MESSAGE_FIELD_NUMBER: _ClassVar[int]
    success: bool
...
class SendSwarmMessageRequest(_message.Message):
    __slots__ = ("workflow_id", "message")
    WORKFLOW_ID_FIELD_NUMBER: _ClassVar[int]
    MESSAGE_FIELD_NUMBER: _ClassVar[int]
    workflow_id: str
    message: str
    def __init__(self, workflow_id: _Optional[str] = ..., message: _Optional[str] = ...) -> None: ...

class SendSwarmMessageResponse(_message.Message):
